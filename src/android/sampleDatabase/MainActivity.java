//package com.example.administrator.sampledatabase;
//
...
//        db.execSQL("insert into " + name + "(name, age, phone) values ('Mike',35,'010-8888-1234');");
//        db.execSQL("insert into " + name + "(name, age, phone) values ('Sean',26,'010-6677-1234');");
//
//        return count;
//    }
//
