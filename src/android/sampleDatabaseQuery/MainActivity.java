//package com.example.administrator.sampledatabasequerry;
//
...
//        Cursor c1 = db.query(TABLE_NAME,columns,whereStr,whereParams,null,null,null);
//
//        int recordCount = c1.getCount();
//        println("cursor count : "+recordCount + "\n");
//
...
//                db.execSQL("insert into "+TABLE_NAME+"(name, age, phone) values ('Mike',35,'010-7788-1234');");
//                db.execSQL("insert into "+TABLE_NAME+"(name, age, phone) values ('Sean',26,'010-7188-1234');");
//            }catch(Exception ex){
