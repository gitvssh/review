...
<%
ProductMgr dao=ProductMgr.getDao();
...
<form method="post" action="CartProc.jsp">
	<table align="center" border="1" width="80%" cellpadding="3" bgcolor="ivory">
		...
		<tr>
			<td>가격</td>
			<td><input type="text" name="price" id="price" value="<%=dto.getPrice() %>"></td>
		</tr>
		...
		<%--
		 ...
		 <tr>
		 	...
		 	<%-- <td>
		 	<input type="number" min="1" max="20" step="1" name="quantity" id="quantity" required="required"/>
		 	</td>--%>
