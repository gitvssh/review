...
<body bgcolor="#ccdd99">
<center><h2>게시판 글수정폼</h2></center>
<%=request.getServletContext().getContextPath() %>

<form method="post" action="edit.do" onSubmit="return check()">
	<table border="2" bgcolor="#ccdd99" width="70%">
	
		<tr>
			<td>글쓴이</td>
			<td><input type="text" id="writer" name="writer" size="10" value="${boardDto.writer}"/></td>
		</tr>
		...
		<tr>
			<td>이메일</td>
			<td><input type="text" id="email" name="email" size="30" value="${boardDto.email}"/></td>
		</tr>
